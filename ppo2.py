...
#            print('*********************',type(self.n_envs),type(self.n_steps))
            ...
            with self.graph.as_default():
                ...
                act_model = self.policy(self.sess, self.observation_space, self.measures_sapce, self.hl_command_space,
                                        self.action_space, self.n_envs, 1,n_batch_step, reuse=False)
                
                with tf.variable_scope("train_model", reuse=True,
                                       custom_getter=tf_util.outer_scope_getter("train_model")):
                    train_model = self.policy(self.sess, self.observation_space, self.measures_sapce, 
                                              self.hl_command_space,self.action_space,
    ...
    def _train_step(self, learning_rate, cliprange, obs, measures, hl_command,returns, masks, 
        ...
        td_map = {self.train_model.obs_ph: obs, self.train_model.mes_ph: measures,
                  self.train_model.hl_ph: hl_command, self.action_ph: actions,
                ...
                if states is None:  # nonrecurrent version
                    ...
                    for epoch_num in range(self.noptepochs):
                        ...
                        for start in range(0, self.n_batch, batch_size):
                            ...
                            slices = (arr[mbinds] for arr in (obs, measures, hl_command, returns, masks, actions, values, neglogpacs))
